            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="productContent">
                        ...
                        <div class="desc">
                            <p>Easy to dump trailers because of the suitable flat bottom provided.</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="tableData bgGrey">
        <div class="container">
            <div class="col-sm-12 col-md-12">
                <div class="title-area mb-0">
                    <span class="sub-title">Technical specification
                        <span class="shape right">
                            <span class="dots"></span>
                        </span>
                    </span>
                ...
                <div class="table-responsive pt-5 pb-0">
                    <table class="table table-bordered">
                        <tbody>
                            <tr>
                                <th>Models</th>
                                <th>Width of Machine (MM)</th>
                                <th>Inclined Part (MM)</th>
                                <th>Total Capacity (M³)</th>
                                <th>Running Capacity (M³)</th>
                            </tr>
                            <tr>
                                <td>AVH-6.0</td>
                                <td>1400</td>
