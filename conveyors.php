                    ...
                    <div class="productImg">
                        <div class="swiper productSwiper">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                $data = glob("assets/img/products/details/conveyors/*.*");
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="productContent">
                        <div class="title-area mb-0">
                            ...
                            <h2 class="sec-title mb-0"> Conveyors</h2>
                        </div>
                        <div class="desc">
                            <ul>
                                <li><i class="fa-light fa-chevrons-right"></i> Bag Filling Conveyor</li>
                            </ul>
                        </div>
                    </div>
                </div>
