...
<div class="banner-breadcrumb">
    ...
    <div class="banner-tit">
        <h2><span> Inspection table with 1 Conveyor</span></h2>
    </div>
</div>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    <!-- <div class="productImg">
                        <img src="assets/img/products/details/inspection-table/inspection-table.webp" alt="Washer">
                    </div> -->
                    <div class="productImg">
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="productContent">
                        <div class="title-area mb-0">
                            ...
                            <h2 class="sec-title mb-0"> Inspection table with 1 Conveyor</h2>
                        </div>
                    </div>
                </div>
