...
<head>
    ...
    <title>Allvege Process Technologies</title>
    <link rel="shortcut icon" href="./assets/img/logo/allvege-fev.webp" type="image/x-icon">
...
<?php
$class = "header-layout6";
// echo $_SERVER['REQUEST_URI'];
if ($_SERVER['REQUEST_URI'] == "/AllVege/index.php" || $_SERVER['REQUEST_URI'] == "AllVege/" || $_SERVER['REQUEST_URI'] == "/index.php" || $_SERVER['REQUEST_URI'] == "/") {
...
<body>
    ...
    <div class="as-menu-wrapper">
        <div class="as-menu-area text-center">
            ...
            <div class="mobile-logo"><a href="index.php"><img src="./assets/img/logo/all-vege-logo.webp"></a>
            </div>
            <div class="as-mobile-menu">
                <ul>
                    ...
                    <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                            ...
                            <!-- <li><a href="receiving-hopper-20-tph.php">Receiving Hopper (20 TPH)</a></li> -->
                             <li><a href="receiving-hopper-20-tph.php">Receiving Hopper</a></li>
                    ...
                    <li class="menu-item-has-children">
                        <a href="process-flow.php">Process Flow</a>
                        <ul class="sub-menu">
                            <li><a href="potato-flakes-line.php">Potato Flakes Line</a></li>
                            <li><a href="pоtаtо-сhips.php">Pоtаtо Сhips</a></li>
                            <li><a href="french-fries-line.php">French Fries Line</a></li>
                            <li><a href="onion-processing-line.php">Onion Processing Line</a></li>
                        </ul>
                    </li>
                ...
                <div class="row justify-content-center justify-content-md-between align-items-center gy-2">
                    ...
                    <div class="col-auto">
                        <div class="header-links">
                            <ul>
                                <li>
                                    <div id="google_translate_element" style="line-height: 17px;"></div>
                ...
                <div class="menu-area ">
                    <div class="container">
                        <div class="row align-items-center justify-content-between">
                            <div class="col-auto">
                                <div class="header-logo"><a href="index.php"><img src="./assets/img/logo/all-vege-logo.webp"></a></div>
                            </div>
                            <div class="col-auto">
