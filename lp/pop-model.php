...
$companyname = "AllVege Process Technology";
$phone = "+91 76008 14075"; /* FORMATE: +91 00000 00000 */
$whatappphone = $whatappphone1 = "917600814075";/* FORAMTE: 91000000000 */
$email = "info@allvege.co.in";
$logo = "assets/img/logo/all-vege-logo.webp"; /* FORMATE: images/logo3.png */
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-body stick_popup">
                <h5 class="modal-title">Share your details &<br>our experts will respond within 12 hours.</h5>
...
<div class="whatsapp-button">
    ...
    <a onclick="gtag('event', 'send', { 'event_category': 'click on whatsapp', 'event_action': 'Mobile', 'event_label': '+<?php echo $whatappphone1;?>' });"
            href="https://api.whatsapp.com/send?phone=<?php echo $whatappphone1;?>&amp;text=<?php echo $message;?>" target="_blank" class="whatsapp-info pulse">
        <span class="whatsapp">
            <i class="fab fa-whatsapp"></i>
        </span>
    </a>
...
<div class="footer-box" style="display: none;">
    <div class="book-app" style="background:#d25d21;" id="req-apnmt2">
        <a class="nav_up click1" href="javascript:;" style="color:#FFF; font-size:14px;font-weight:600;"><i
                class="fa fa-envelope" style="margin-right: 5px;"></i> Get Pricing Details</a>
    </div>
