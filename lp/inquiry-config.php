...
define('CONTACT_PAGE', 'allvege.co.in/lp');
...
define('EMAIL_SUBJECT', 'New Inquiry From '.COMPANY_NAME.' - Landing Page');
define('CATALOGUE_EMAIL_SUBJECT', 'New Catalogue Request From '.COMPANY_NAME.' - Landing Page');
