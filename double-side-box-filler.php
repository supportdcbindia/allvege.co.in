...
<div class="banner-breadcrumb">
    ...
    <div class="banner-tit">
        <h2><span> Double side Box Filler</span></h2>
    </div>
</div>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    <!-- <div class="productImg">
                        <img src="assets/img/products/details/double-side-box-filler/double-side-box-filler.webp" alt="Washer">
                    </div> -->
                    ...
                    <div class="productImg">
                        <div class="swiper productSwiper">
                            <div class="swiper-wrapper">
                                ...
                                $data = glob("assets/img/products/details/double-side-box-filler/*.*");
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="productContent">
                        <div class="title-area mb-0">
                            ...
                            <h2 class="sec-title mb-0"> Double side Box Filler</h2>
                        </div>
                    </div>
                </div>
